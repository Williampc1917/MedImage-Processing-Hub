'use client'; // This line should be the very first line of your file.
...
export default function SignIn() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Redirect or do something with the success response here
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="max-w-sm mx-auto">
              ...
              {error && (
                  <div className="mt-4 text-center p-2 bg-red-100 text-red-600 rounded">
                    {error}
                  </div>
              )}
              ...
              {successMessage && (
                  <div className="mt-4 text-center p-2 bg-green-100 text-green-600 rounded">
                    {successMessage}
                  </div>
              )}
